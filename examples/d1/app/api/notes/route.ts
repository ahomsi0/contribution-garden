...
function toRouteErrorMessage(error: unknown) {
  ...
  // Only map known setup problems to a client-facing hint; raw database
  ...
  console.error("notes_route_error", message, detail);
  return "The notes store is unavailable right now.";
}
